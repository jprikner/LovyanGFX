...
#define INPUT_STEPS     256     // input resolution of the brightness regulation
...
//----------------------------------------------------------------------------
  ...
  public:
    ...
    uint8_t calculateBrightness ( uint8_t input ) ;

  private:
    config_t _cfg ;
    uint8_t buf = 0x01 ; // buffer for I2C manager R/W ops
  };
